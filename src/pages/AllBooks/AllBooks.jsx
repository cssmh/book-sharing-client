...
const AllBooks = () => {
  ...
  return (
    <div>
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-[1250px] mx-auto my-10">
          {[...Array(3)].map((_, index) => (
        ...
        <div>
          {data?.result?.length === 0 ? (
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-[1250px] mx-auto">
