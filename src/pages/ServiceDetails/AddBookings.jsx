...
const AddBookings = ({ service }) => {
    ...
    const { _id, book_image, book_name, description, book_provider_image, book_provider_name, book_provider_email, phone } = service;
    ...
    const handleBook = e => {
        ...
        const booking = {
            book_name, book_image, book_provider_email, user_email, date, instruction, phone,status
        }
                ...
                <DialogContent>
                    <form onSubmit={handleBook} className=" md:w-3/4 lg:w-1/2 mx-auto">
                        <div className="form-control">
                            ...
                            <input type="text" readOnly name="book_name" defaultValue={book_name} className="input input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Book Image Url</span>
                            </label>
                            <input type="text" readOnly name="book_image" defaultValue={book_image} className="input input-bordered" />
                        </div>
                        ...
                        <div className="form-control">
                            ...
                            <input type="email" readOnly name="book_provider_email" defaultValue={book_provider_email} className="input input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
