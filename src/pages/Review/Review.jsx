      ...
      <div className="grid grid-cols-1 md:grid-cols-2 my-10 gap-4">
        ...
        >
          <img
            ...
            alt=""
          />
          <h1 className="text-xl font-semibold text-green-400">Programming with C++</h1>
          <p className="px-5">
            A Comprehensive Guide" by John Smith is a must-have for both
            beginners and experienced programmers alike. Smith's thorough
            approach to explaining complex concepts in a clear and accessible
            manner makes this book an invaluable resource for anyone looking to
            deepen their understanding of C++. From basic syntax to advanced
            topics like templates and multithreading, Smith covers it all with
        ...
        >
          <img
            ...
            alt=""
          />
          <h1 className="text-xl font-semibold text-green-400">OPERATING SYSTEM</h1>
          <p className="px-5">
        ...
        >
          <img
            ...
            alt=""
          />
          <h1 className="text-xl font-semibold text-green-400">Data Structure</h1>
          <p className="px-5">
        ...
        >
          <img
            ...
            alt=""
          />
          <h1 className="text-xl font-semibold text-green-400">Discrete Mathematics</h1>
          <p className="px-5">
            "Discrete Mathematics and Its Applications" by Kenneth H. Rosen is
            an essential textbook for anyone studying discrete mathematics. This
            ...
            more. Rosen's clear and concise explanations make complex concepts
