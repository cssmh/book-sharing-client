  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 my-10 gap-4">
        <div className="border bg-base-200 py-7 rounded-lg space-y-2 text-center">
          <img
            src={momin}
          ...
          <div data-aos="zoom-in-up" data-aos-duration="1000">
            ...
            <p className="px-5">
              ...
              beginners and experienced programmers alike. Smith thorough
              approach to explaining complex concepts in a clear and accessible
              manner makes this book an invaluable resource for anyone looking
              to deepen their understanding of C++. From basic syntax to
              advanced topics like templates and multithreading, Smith covers it
              all with precision and depth. His real-world examples and
              practical exercises not only reinforce learning but also provide
              invaluable insights into best practices and common pitfalls.
            </p>
          </div>
          <img src={review} className="mx-auto" alt="" />
        </div>
        <div className="border bg-base-200 pt-6 pb-3 rounded-lg space-y-2 text-center">
          <img
            src={mahbub}
            className="w-12 mx-auto rounded-3xl border border-green-500"
            alt=""
          ...
          <div data-aos="zoom-in-up" data-aos-duration="1000">
            ...
            <p className="px-5">
              ...
              like file systems and virtualization, the book covers all aspects
              of operating system design and implementation.
            </p>
          </div>
          <img src={review} className="mx-auto" alt="" />
        </div>
        <div className="border bg-base-200 py-7 rounded-lg space-y-2 text-center">
          ...
          <div data-aos="zoom-in-up" data-aos-duration="1000">
            ...
            <p className="px-5">
              ...
              algorithm, accompanied by Python code examples and illustrations
        ...
        <div className="border bg-base-200 py-7 rounded-lg space-y-2 text-center">
          ...
          <div data-aos="zoom-in-up" data-aos-duration="1000">
            ...
            <p className="px-5">
              Discrete Mathematics and Its Applications by Kenneth H. Rosen is
              an essential textbook for anyone studying discrete mathematics.
              This comprehensive guide covers a wide range of topics including
              logic, set theory, relations, functions, graph theory,
              combinatorics, and more. Rosen clear and concise explanations make
              complex concepts accessible to students at all levels. Each
              chapter is carefully structured with numerous examples, exercises,
              and problems to reinforce learning and facilitate understanding.
            </p>
          </div>
          <img src={review} className="mx-auto" alt="" />
        </div>
