      ...
      <dialog id="my_modal_4" className="modal">
        <div className="modal-box w-11/12 max-w-5xl">
          ...
          <p className="py-1">
            ...
            <br />
            10. On the &apos;My Added Books&apos; page, users can view the books
            they have added. For each book, they have the option to view
            ...
            &apos;Details&apos; button will be displayed. <br />
            <br />
            ...
            booked any of the user&lsquo;s books. <br />
            <br />
            ...
            been taken. <br />
            <br />
            22. Added React Spinners, HashLoader, and other awesome React
            packages. <br />
            <br />
            23. The counting component on the homepage dynamically displays the
            total number of users and book providers. <br />
            <br />
            24. Implemented JSON Web Token (JWT) for authorization. Only
            logged-in users can access their own data, not others. <br />
            <br />
            25. Used interceptors to automatically log out users and redirect
            them to the login page if the token expires or encounters any
            issues. <br />
            <br />
            26. Created an admin dashboard accessible only to admin@***.com.
            Other users attempting to access this route will be automatically
            redirected to the homepage. <br />
            <br />
            27. The &quot;More Books of a User&quot; page and the Admin Page
            ...
            <br />
            <br />
            28. In the admin dashboard, the admin can view the total number of
            ...
            <br />
            29. Access to all bookings from the database is restricted to
            ...
            <br />
            <br />
            30. The admin can delete any bookings, including completed bookings,
            or all bookings at once. <br />
            <br />
            31. Users cannot update other users&apos; book data using the book
            ...
            <br />
            32. Users cannot delete any book using Postman with the book ID from
